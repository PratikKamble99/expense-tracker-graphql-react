...
const RootLayout = () => {
  ...
  return (
    <div className="sm:flex h-full">
      <nav className="sm:hidden w-full relative">
        <div className="flex flex-wrap items-center justify-between p-4">
          ...
          <button
            ...
            type="button"
            className="inline-flex items-center p-2 w-10 h-10 justify-center text-sm text-gray-500 rounded-lg md:hidden hover:bg-[#28282A] focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600"
      ...
      <aside className={`w-[${SIDEBAR_WIDTH}] hidden sm:block`}>
        <SidebarProvider>
          <AppSidebar />
        </SidebarProvider>
      </aside>
